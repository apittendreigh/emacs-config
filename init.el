...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flycheck web-mode php-mode ac-emmet emmet-mode auto-complete company-irony pretty-mode expand-region mark-multiple swiper popup-kill-ring symon dmenu diminish spaceline company rainbow-delimiters sudo-edit hungry-delete switch-window rainbow-mode avy smex ido-vertical-mode org-bullets beacon which-key use-package spacemacs-theme))))
(custom-set-faces
